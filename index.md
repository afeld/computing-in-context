...
| ---------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------- | ---------------------------------------------------------------- | --------------------------------------------------------- |
| [8](week_8_reading.md) | **Oct 21**<br/>None                     | **Oct 22**<br/>[Lecture 15: Introduction to the Policy context](lecture_15.ipynb)<br/><br/>[_New location and instructor_](#meeting-information) | **Oct 23**<br/>Lab 7                | **Oct 24**<br/>[Lecture 16: Working with data](lecture_16.ipynb) | **Oct 25**<br/>[Lab 8: Working with data](lab_8_guide.md) |
| 9                      | **Oct 28**<br/>None                     | **Oct 29**<br/>Lecture 17: Manipulating data                                                                                                     | **Oct 30**<br/>[Lab 8](lab_8.ipynb) | **Oct 31**<br/>Lecture 18: Combining data                        | **Nov 1**<br/>Lab 9: Filtering and joining                |
...
Reading should be completed before the lab that week. For example: [Week 8 reading](week_8_reading.md) should be completed before Lab 8.
