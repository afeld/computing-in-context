...
Built using [Jupyter Book](https://jupyterbook.org/). To run locally:
...
1. [Build the site.](https://jupyterbook.org/en/stable/basics/build.html#build-via-the-command-line)
