...
# copied from https://github.com/jupyter-book/jb1-redirect-generator/pull/3
...
def discover_myst_config() -> Path:
    ...
    raise FileNotFoundError(
        "Could not find myst.yml in common locations (./myst.yml, ./docs/myst.yml). Use --myst-config to specify the path explicitly."
    )
...
def generate_redirects(
    ...
    index_slug = sanitize_for_myst_url(index_file_path.replace(".md", "").replace(".ipynb", ""))
